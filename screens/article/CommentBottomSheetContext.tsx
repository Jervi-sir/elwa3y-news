...
export const CommentsBottomSheetContext = createContext(null);

export const useCommentsBottomSheet = () => {
  return useContext(CommentsBottomSheetContext);
};

export const CommentsBottomSheetProvider = ({ children }) => {
  ...
  const openCommentsBottomSheet = useCallback((content, customSnapPoints) => {
  ...
  return (
    <CommentsBottomSheetContext.Provider value={{ openCommentsBottomSheet, onClose, popContent }}>
